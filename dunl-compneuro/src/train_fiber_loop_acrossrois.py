...
def init_params():
    ...
    parser.add_argument(
        ...
        default="photometry_dopamine_trail_config.yaml",
    )
...
def main(params, random_date):
    print("Train DUNL on neural data (independent kernels for each ROI).")
    ...
    if params["share_kernels_among_rois"]:
