...
def init_params():
    ...
    parser.add_argument(
        ...
        help="data path",
        default= "",
        # "Data\processed_ca_resp_to_paired_pulses_2_data.npy",
        # "Data\processed_ca_resp_to_paired_pulses_data.npy",
    )
    parser.add_argument(
        "--data-folder",
        type=str,
    ...
    parser.add_argument(
        ...
        # default = 20 # for trials simulated at 100ms resolution for 2000 ms kernel 
        default = 20
    )
    parser.add_argument(
        "--kernel-num",
